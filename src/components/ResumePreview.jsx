...
<body>
  ...
  const expLines = (data.expPolished || data.expDesc || '').split('\n').filter(l => l.trim());
  ...
  return (
    <section className="preview-panel">
      <div className="preview-header">
        ...
        <button className="download-btn" onClick={downloadHTML} disabled={!isBuilt}>
      ...
      {!isBuilt ? (
        <div className="empty-state">
          ...
          <p>Fill in your details and click <strong>Build resume</strong></p>
        </div>
      ) : (
        <div className="paper-wrapper">
          <div className="paper" ref={resumeRef}>
            ...
            <div className="r-contacts">
              {data.email && <span><i className="ti ti-mail" aria-hidden="true"></i> {data.email}</span>}
              {data.phone && <span><i className="ti ti-phone" aria-hidden="true"></i> {data.phone}</span>}
              {data.location && <span><i className="ti ti-map-pin" aria-hidden="true"></i> {data.location}</span>}
              {data.website && <span><i className="ti ti-world" aria-hidden="true"></i> {data.website}</span>}
              {data.github && <span><i className="ti ti-brand-github" aria-hidden="true"></i> {data.github}</span>}
              {data.linkedin && <span><i className="ti ti-brand-linkedin" aria-hidden="true"></i> {data.linkedin}</span>}
            </div>
            ...
            {(data.summary || data.summaryContext) && (
              <>
                ...
                <div className="r-summary">{data.summary || data.summaryContext}</div>
              </>
            )}
              ...
              <>
                ...
                <div className="r-exp">
                  <div className="r-exp-header">
                    ...
                    <div className="r-exp-date">{data.expFrom}{data.expTo ? ` – ${data.expTo}` : ''}</div>
                  </div>
            ...
            {(data.degree || data.university) && (
              <>
                ...
                <div className="r-exp">
                  ...
                  {data.cgpa && <div className="r-exp-meta">CGPA: {data.cgpa}</div>}
                </div>
              </>
            )}
